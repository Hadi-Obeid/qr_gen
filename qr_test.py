...
def test_alpha():
    qr = QRCode(QREncoding.ALPHA, "Q", 1, "AC-42")
    assert qr.data == "00100000001010011100111011100111001000010000000011101100000100011110110000010001111011000001000111101100"
